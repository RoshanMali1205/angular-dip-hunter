    ...
    <div class="space-y-6">
      ...
      <div class="text-center">
        <h2 class="text-xl font-bold"
            ...
            [class.text-gray-900]="themeService.isLight()">{{ lang.t('auth.welcomeBack') }}</h2>
      ...
      @if (showRegistrationSuccess()) {
        <div class="rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-400">
          <div class="flex items-center gap-2">
            ...
            {{ lang.t('auth.registrationSuccess') }}
          </div>
        </div>
      }
        ...
        <div class="flex items-center justify-between">
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              ...
              [(ngModel)]="rememberMe"
              name="rememberMe"
              class="w-4 h-4 rounded border-slate-600 bg-slate-800 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-0">
            <span class="text-sm"
                  [class.text-slate-400]="themeService.isDark()"
      ...
      <p class="text-center text-sm"
        ...
        <a routerLink="/auth/register" class="font-medium text-emerald-500 hover:text-emerald-400 transition">
